...
public class IssuebookDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_issueDetails.setColorBackgoundHead(new java.awt.Color(0, 102, 102));
        tbl_issueDetails.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        tbl_issueDetails.setColorFilasForeground1(new java.awt.Color(0, 153, 153));
        tbl_issueDetails.setColorFilasForeground2(new java.awt.Color(0, 153, 153));
        tbl_issueDetails.setColorSelBackgound(new java.awt.Color(0, 102, 102));
        tbl_issueDetails.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 25)); // NOI18N
        tbl_issueDetails.setFuenteFilas(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        tbl_issueDetails.setFuenteFilasSelect(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        tbl_issueDetails.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 20)); // NOI18N
